...
rule_id = place_gtt_order(instrument_list,"IDEA","BUY",500,10)
...
# modify_gtt_order(rule_id, instrument_list, "IDEA", 550, 5)
cancel_gtt_order(rule_id, instrument_list,"IDEA")
